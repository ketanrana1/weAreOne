...
export class BookController {
  ...
  async postBook( @Body() body: any, 
    ...
    const bookSchema = Joi.object({
      ...
      book_description_two: Joi.string().label('Book Description Two'),
  ...
  @UploadedFile("book_image", { options: fileUploadOptions() }) file : any ) {
    ...
    if ( file === undefined || file == null  || Object.keys(file).length === 0 ) {          
      ...
      book_description_two: body.book_description_two,
      ...
      book_description_two: bookBody.book_description_two,
